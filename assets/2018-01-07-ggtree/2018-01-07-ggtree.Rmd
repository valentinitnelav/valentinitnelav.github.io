...
I use in this example [ggtree]( https://bioconductor.org/packages/release/bioc/html/ggtree.html) R package, which is designed for "visualization and annotation of phylogenetic trees with their covariates and other associated data".
...
# Not sure why the labels got a weird angle though.
tree_bars
```
